...
import cc.azuramc.bedwars.listeners.player.AFKListener;
...
import cc.azuramc.bedwars.utils.GameUtil;
import lombok.Data;
import org.bukkit.*;
...
public class GameManager {
    ...
    private GameStartRunnable gameStartRunnable = null;
    ...
    private void checkGameStart() {
        if (isStartable() && gameState == GameState.WAITING && getGameStartRunnable() == null) {
            GameStartRunnable lobbyCountdown = new GameStartRunnable(this);
            lobbyCountdown.runTaskTimer(main, COUNTDOWN_TICK_PERIOD, COUNTDOWN_TICK_PERIOD);
            setGameStartRunnable(lobbyCountdown);
        }
    }
