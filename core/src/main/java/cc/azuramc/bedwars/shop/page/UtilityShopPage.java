...
//        shopItems.add(new ShopItemType(new ItemBuilder().setType(XMaterial.SPONGE.get()).getItem(),"魔法牛奶",ColorType.NONE,new PriceCost(XMaterial.GOLD_INGOT.get(),4,40))); // 没写逻辑
