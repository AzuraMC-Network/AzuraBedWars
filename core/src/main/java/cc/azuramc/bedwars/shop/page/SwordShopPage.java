...
public class SwordShopPage implements ShopData {
    ...
    public SwordShopPage() {
        ...
        shopItems.add(new ShopItemType(new ItemBuilder().setType(XMaterial.STICK.get()).addEnchant(XEnchantment.KNOCKBACK.get(), 1).getItem(), "击退棒", ColorType.NONE, new PriceCost(XMaterial.GOLD_INGOT.get(), 10, 150)));
    }
