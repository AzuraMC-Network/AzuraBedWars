...
public class CustomSilverfish extends AbstractCustomEntity {
    ...
    protected CustomSilverfish(Mob entityInsentient, GameTeam gameTeam) {
    ...
    protected void setupGoals() {
        ...
        mob.goalSelector.addGoal(2, new MeleeAttackGoal(pathfinderMob, 1.9D, false));
        mob.goalSelector.addGoal(3, new MoveTowardsTargetGoal(pathfinderMob, 1.0D, 20.0F));
        mob.goalSelector.addGoal(4, new RandomStrollGoal(pathfinderMob, 1.5D));
