package cc.azuramc.bedwars.nms.v1_12_R1;
...
public class CustomIronGolem extends AbstractCustomEntity {
    ...
    public static LivingEntity spawn(Location loc, GameTeam gameTeam, double speed, double health, double damage) {
        ...
        Objects.requireNonNull(bukkitLivingEntity.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED), "Spawn IronGolem speed parameter is null").setBaseValue(speed);
        Objects.requireNonNull(bukkitLivingEntity.getAttribute(Attribute.GENERIC_MAX_HEALTH), "Spawn IronGolem health parameter is null").setBaseValue(health);
        Objects.requireNonNull(bukkitLivingEntity.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE), "Spawn IronGolem damage parameter is null").setBaseValue(damage);
